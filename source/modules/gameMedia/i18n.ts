export default {
  messages: {
    en: {
      ...
      cover_image_hint: 'Main game image for store.',
      cover_image_descr: `The cover image is used on the main game page on the store and could be used as a special feature block on the store main page. 
Required at least 1920х800 image (aspect 1.77) in PNG or JPEG format. 
Please avoid duplicating your project's screenshots here.`,
...
Slow theatrical performances are suitable for a cinematic trailer on YouTube, but buyers are much more important to see what is the gameplay.</p>`,
      ...
      trailers: 'Additional trailers',
      trailers_descr: `You can add more trailers to the game page. 
They would be placed on the screenshot block of the game page. 
Video always has priority to screenshots and would be shown before them. 
We also would use this video for play it after the cover video ends.`,
      upload_trailer: 'Upload cover video',
      replace_trailer: 'Replace cover video',
      remove_trailer: 'Remove video',
...
Show your customers what the gameplay is. Screenshots of the menu should be downloaded only if they are a unique component of the game.</p>`,
      ...
      add_screenshot: 'Add item',


      store: 'Store preview',
      store_descr: `We require you to prepare and upload some additional content for the store main page promotion sections.`,
      store_descr_vert: "Used on the top of the store main page or in some section based blocks. Should be 1920x1080.",
      store_descr_horiz: "Used on the top of the store main page or in some section based blocks. Should be 1920x1080.",
      upload_store_v: 'Add vertical image',
      upload_store_h: 'Add horizontal image',
      replace_store: 'Replace',
      remove_store: 'Remove',


      capsule: 'Capsule',
      capsule_descr: `The main representation for game on the store page and in the player games library. 
      Should be uploaded in generic and small sizes. All other image sizes would be created automatically.`,
      upload_capsule: 'Upload picture',
      replace_capsule: 'Replace',
      remove_capsule: 'Remove',
      add_capsule: 'Add picture',
    },
    ru: {
      cover_image: 'Обложка',
      cover_image_hint_title: 'Обложка',
      cover_image_hint: 'Основное изображение игры в магазине.',
      cover_image_descr: `Изображение обложки используется на главной странице игры в магазине и может использоваться в качестве специального блока на главной странице магазина. 
Требуемый размер не менее 1920х800 пикселей (аспект 1.77) в формате PNG или JPEG. 
Пожалуйста, избегайте дублирования скриншотов вашего проекта.`,
...
Мы также будем использовать это видео для воспроизведения после того, как закончится видео на обложке.`,
      upload_trailer: 'Загрузить трейлер',
      replace_trailer: 'Заменить трейлер',
      remove_trailer: 'Удалить',
...
Покажите своим клиентам, что такое геймплей. Скриншоты меню следует загружать только в том случае, если они являются уникальным компонентом игры.</p>`,
      ...
      add_screenshot: 'Добавить',

      store: 'Изображения в магазине',
      store_descr: `От вас требуется подготовить и загрузить дополнительный контент для разделов продвижения главной страницы магазина.`,
      store_descr_vert: "Используется в верхней части главной страницы магазина или в некоторых разделах на основе блоков. Должно быть 1920x1080.",
      store_descr_horiz: "Используется в верхней части главной страницы магазина или в некоторых разделах на основе блоков. Должно быть 1920x1080.",
      upload_store_v: 'Загрузить верт. вариант',
      upload_store_h: 'Загрузить гориз. вариант',
      replace_store: 'Заменить',
      remove_store: 'Удалить',

      capsule: 'Капсула',
      capsule_descr: `Основное представление для игры на странице магазина и в библиотеке игр игрока. 
Допустимо загружать обычные и небольшие размеры. Все остальные размеры изображений будут созданы автоматически.`,
      upload_capsule: 'Загрузить',
      replace_capsule: 'Заменить',
      remove_capsule: 'Удалить',
      add_capsule: 'Добавить',
    },
  },
};
